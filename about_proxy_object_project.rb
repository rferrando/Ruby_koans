...
class Proxy
  ...
  def method_missing(method_name, *args, &block)
    ...
    #@method_names.push(method_name) # Tengo que ponerlo arriba ya que sino al no
    #el metodo al no llevar un return asume que tiene que devolver el resultado
    #de la última sentencia
    #puts @method_names.to_s
  end
   def messages
     @method_names
   end
   ...
   def number_of_times_called(method_name)
     @method_names.count(method_name)
   end
end
