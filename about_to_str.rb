...
#   Only the objects that can really coerce themselves into another type expose
#implicit protocols. These methods are #to_str, #to_hash, etc..
#
# If you need your value object to be coerced into a specific primitive,
#consider implementing these coercion protocols.

  def test_to_str_allows_objects_to_be_treated_as_strings
    #puts CanBeTreatedAsString.new.class
