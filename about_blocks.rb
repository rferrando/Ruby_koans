...
class AboutBlocks < Neo::Koan
  def method_with_block
    #Think of the yield keyword as saying: "Stop executing the code in this method,
    #and instead execute the code in this block. Then, return to the code in the method."
    result = yield
    result
  end
